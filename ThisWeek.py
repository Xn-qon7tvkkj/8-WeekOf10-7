...
gender = input("Sir or Madame?")
print("So, you are %r" % (gender))
name = input("Your name is:")
print("Your name is: %r. %r" % (gender, name))
...
print("Ice is in your inventory")
print("You can:")
print("Choice A: Cast the spell")
print("Choice B: Use sword")
choice1 = input("What do you do:")#choice
if (choice1 == "a" or choice1 == "A"):
    print ("You cast the spell, and the room froze to ice. After a second, the icicle shattered, showing no scratch on the Gu's armory.")
    print ("You call your teammate over.")
    print("Choice A: Let's do a combination spell.")
    print("Choice B: Let's try to target his arms.")
    choice2a = input("What do you do?")#choice
    if (choice2a == "a" or choice2a == "A"):
        print("The machine did not attack. It looked at your teammates with blandness.")
        print("You use your weakest spell since that's your strongest in the past.")
        print("Both of your teammates casted Veronica The 2nd.")
        print("They swirl together in the mash of colors.")
    ...
    if (choice1b == "b" or choice2b == "B"):
        ...
        print("Now!")
        print("Your teammates summoned Xerna.")
        print("Xerna eliminated the machine.")
        print("Now, sonny. Let's defeat that leader together!")
choice1 = input("What do you do:")#choice
if (choice1 == "b" or choice1 == "B"):
    print("You hesitated. Space and time had repeatedly been shattered and put back together.")
    print("Taking a deep breath...")
    print("Even for a millisecond, the sword would not cause any harm except what it is targeting.")
    print("The Gu machine is destroyed completely.")
    print("Your teammates stood in awe.")
    print("After a minute, your other teammate said")
    print("%r. You shouldn't have done that. You told us." % (name))
print("Your other teammate shook their head at their teammates and ran on ahead. You tried to stop them, but the most strangest Gu machine stopped you by putting a great trail of flame in front of you.")
print("Do not interrupt Master with your friend's battle. It's the battle between the last Quo and Gu.")
print("As the Gu machinery aimed its tail at you, it stopped and shattered into pieces...")
print("The sword disrupts reality and rewinds to the day of its creation.")
...
print("Your AI, in a form of a bubble, chirped.")
